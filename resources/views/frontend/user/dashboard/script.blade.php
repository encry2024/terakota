...
$(document).ready(function () {
    ...
    $('#check_out_modal').on('show.bs.modal', function (event) {
        ...
        modal.find('#cash').text(Number($('#chargeSaveModal').find('#cash').val()).toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2}));
        modal.find('#change_due').text(Number($('#chargeSaveModal').find('#change').val()).toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2}));

        // Display if dining has price
        @if ($dining->price != 0)
            modal.find('#dining_credit').text(Number($('#chargeSaveModal').find('#deposit').val()).toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2}));
            let ktv_balance = parseFloat(dining_cost) - parseFloat($('#chargeSaveModal').find('#deposit').val());
    ...
    $('#chargeSaveModal').on('show.bs.modal', function () {
        let modal = $(this);
