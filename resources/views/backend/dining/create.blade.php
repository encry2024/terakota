...
@section ('title', __('labels.backend.dinings.management') . ' | ' . __('labels.backend.dinings.create'))
...
@section('content')
{{ html()->form('POST', route('admin.dining.store'))->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">{{ __('labels.backend.dinings.create') }}</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
                ...
                <div class="col">
                    ...
                    {{ html()->label(__('validation.attributes.backend.dinings.price'))->class('col-md-2 form-control-label')->style('line-height: 3')->for('price') }}
                        ...
                        <div class="input-group col-md-10">
                            <span class="input-group-append input-group-text">PHP</span>
                            {{ html()->text('price')
