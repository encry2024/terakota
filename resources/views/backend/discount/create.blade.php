...
@section ('title', __('labels.backend.discounts.management') . ' | ' . __('labels.backend.discounts.create'))
...
@section('content')
{{ html()->form('POST', route('admin.discount.store'))->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">{{ __('labels.backend.discounts.create') }}</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
