...
@section ('title', __('labels.backend.discounts.management') . ' | ' . __('labels.backend.discounts.deleted'))
        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    ...
                    <small class="text-muted">{{ __('labels.backend.discounts.deleted') }}</small>
                </h4>
            </div><!--col-->
        </div><!--row-->
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        @if ($discounts->count())
                            ...
                            @endforeach
                        @else
                            <tr><td colspan="7"><p class="text-center">{{ __('strings.backend.discounts.no_deleted') }}</p></td></tr>
                        @endif
                        </tbody>
                    </table>
                </div>
