...
@section ('title', __('labels.backend.shifts.management') . ' | ' . __('labels.backend.shifts.edit'))
...
@section('content')
{{ html()->modelForm($shift, 'PATCH', route('admin.shift.update', $shift->id))->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">{{ __('labels.backend.shifts.edit') }}</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
            ...
            <div class="row mt-4 mb-4">
                ...
                <div class="form-group row">
                    {{ html()->label(__('validation.attributes.backend.shifts.name'))->class('col-md-2 form-control-label')->style('line-height: 3')->for('name') }}

                        <div class="col-md-10">
                            {{ html()->text('name')
                                ->class('form-control')
                                ->placeholder(__('validation.attributes.backend.shifts.name'))
